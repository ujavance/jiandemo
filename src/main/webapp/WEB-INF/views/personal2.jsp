                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-default">
                        <div class="box-body box-profile">
                            <img class="profile-user-img img-responsive img-circle" src="${APP_PATH }/static/img/${user.userimg}" alt="User profile picture">
                            <h3 class="profile-username text-center">${user.username}</h3>
                            <p class="text-muted text-center">Software Engineer</p>

                            <ul class="list-group list-group-unbordered">
                                <li class="list-group-item">
                                    <b>粉丝</b> <a class="pull-right">${user.fans}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>关注人数</b> <a class="pull-right">${user.follows}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>喜欢</b> <a class="pull-right">${user.likes}</a>
                                </li>
                            </ul>
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="activity">
                                ...
                                <div class="post">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm" src="${APP_PATH }/static/img/user1-128x128.jpg" alt="user image">
                                        <span class="username">
                          ...
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                                ...
                                <div class="post clearfix">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm" src="${APP_PATH }/static/img/user7-128x128.jpg" alt="user image">
                                        <span class="username">
                          <a href="#">Sarah Ross</a>
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                        </span>
                                ...
                                <div class="post">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm" src="${APP_PATH }/static/img/user6-128x128.jpg" alt="user image">
                                        <span class="username">
                          <a href="#">Adam Jones</a>
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                        </span>
                                    ...
                                    <div class="row margin-bottom">
                                        <div class="col-sm-6">
                                            <img class="img-responsive" src="${APP_PATH }/static/img/photo1.png" alt="Photo">
                                        </div><!-- /.col -->
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <img class="img-responsive" src="${APP_PATH }/static/img/photo2.png" alt="Photo">
                                                    <br>
                                                    <img class="img-responsive" src="${APP_PATH }/static/img/photo3.jpg" alt="Photo">
                                                </div><!-- /.col -->
                                                <div class="col-sm-6">
                                                    <img class="img-responsive" src="${APP_PATH }/static/img/photo4.jpg" alt="Photo">
                                                    <br>
                                                    <img class="img-responsive" src="${APP_PATH }/static/img/photo1.png" alt="Photo">
                                                </div><!-- /.col -->
                                            </div><!-- /.row -->
